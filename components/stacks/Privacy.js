    ...
    return (
      <ScrollView style={cstyles.container}>
        <Text style={styles.content}>
          Aziz Rahman built the Quiva app as an Open Source app. This
          SERVICE is provided by Aziz Rahman at no cost and is intended for use
          ...
          Conditions, which is accessible at Quiva unless otherwise defined
        ...
        <Text style={styles.content}>
          ...
          will be able to do necessary actions. Changes to This Privacy Policy I
          may update our Privacy Policy from time to time. Thus, you are advised
        ...
        <Text style={styles.content}>
          ...
          not hesitate to contact me at azizstark@gmail.com
        </Text>
      </ScrollView>
    );
  }
